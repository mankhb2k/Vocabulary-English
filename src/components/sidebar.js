  ...
  return `
    <aside class="sidebar" aria-label="Main navigation">
      ...
      <nav class="main-nav">
        ...
        <button class="nav-item c-button" data-view="ask" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M5 5.5A2.5 2.5 0 0 1 7.5 3H19a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-7l-4.5 4V17h-.5A2.5 2.5 0 0 1 5 14.5v-9Z"/><path d="M9 8h6M9 12h4"/></svg><span>Chat AI</span></button>
      </nav>
    </aside>`;
}
