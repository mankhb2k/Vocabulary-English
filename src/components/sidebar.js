export function Sidebar() {
  return `
    <aside class="sidebar" aria-label="Main navigation">
      ...
      <nav class="main-nav">
        <button class="nav-item c-button is-active" data-view="study" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H20v15H6.5A2.5 2.5 0 0 0 4 20.5v-15Z"/><path d="M4 20.5A2.5 2.5 0 0 1 6.5 18H20M8 7h8M8 11h5"/></svg><span>Study</span></button>
        <button class="nav-item c-button" data-view="library" type="button"><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 5.5A2.5 2.5 0 0 1 6.5 3H20v15H6.5A2.5 2.5 0 0 0 4 20.5v-15Z"/><path d="M4 7h16M8 11h8M8 14h5"/></svg><span>Library</span></button>
